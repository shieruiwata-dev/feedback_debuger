...
export const mockItems: FeedbackItem[] = [
  ...
  {
    // 1 つの長文が論点ごとに分割された例（1/2）
    id: "i1000000-0000-4000-8000-000000000009",
    app_id: APP_ID,
    source_type: "slack",
    raw_text: "検索が遅くて5秒くらい待たされます",
    summary: "検索の応答が遅い",
    priority: "high",
    category: "bug",
    cluster_id: "c1000000-0000-4000-8000-000000000002",
    ...
    parent_item_id: "i1000000-0000-4000-8000-00000000000p",
    segment_index: 1,
    is_feedback: true,
    triage_reason: "ai:feedback",
  ...
  {
    // 同上（2/2）。別の論点なので別クラスタに入る
    id: "i1000000-0000-4000-8000-000000000010",
    app_id: APP_ID,
    source_type: "slack",
    raw_text: "申請履歴をCSVで出せると助かります",
    summary: "申請履歴のCSVエクスポート要望",
    priority: "medium",
    category: "feature_request",
    cluster_id: "c1000000-0000-4000-8000-000000000002",
    source_meta: {
